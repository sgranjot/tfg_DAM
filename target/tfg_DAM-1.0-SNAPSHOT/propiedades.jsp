<%-- 
    ...
    Created on : 20 may. 2023, 23:53:46
    Author     : sgranjot
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="content">
            ...
            <!--Tabla propiedades-->
            <div class="info">
                <h2>Información de las Propiedades</h2>
                <hr>
            </div>
            ...
            <div class="miTabla">
                <table>
                    ...
                    <tfoot class="footer-table">
                        <tr>
                            <td><button id="aniadirProp" class="button" name="añadir" onclick="javascript:aniadirPropiedad()">añadir</button></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
            ...
            <script>
                ...
                for (let i = 0; i < propiedades.length; i++) {
                    ...
                    fila.addEventListener("click", function () {
                        window.location.href = "servletMostrarPropiedad?propiedadId=" + idSeleccion;
                    });
